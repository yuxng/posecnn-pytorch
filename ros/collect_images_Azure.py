...
class ImageListener:
    ...
    def __init__(self):
        ...
        self.outdir = osp.join(this_dir, '..', 'data', 'Azure')

        # initialize a node
        rospy.init_node("image_listener")
        rgb_sub = message_filters.Subscriber('/rgb/image_raw', Image, queue_size=2)
        depth_sub = message_filters.Subscriber('/depth_to_rgb/image_raw', Image, queue_size=2)
